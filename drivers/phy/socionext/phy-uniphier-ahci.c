...
static int uniphier_ahciphy_probe(struct platform_device *pdev)
{
	...
	priv->rst_parent = devm_reset_control_get(dev, "link");
	if (IS_ERR(priv->rst_parent))
		priv->rst_parent = NULL;
